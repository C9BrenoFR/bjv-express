...
export default function EditPackagePage({ package: pkg }: PageProps) {
    const { data, setData, put, processing, errors } = useForm({
        ...
        state: pkg.address.state,
        zip_code: pkg.address.zip_code,
